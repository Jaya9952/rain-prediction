...
class WeatherInput(BaseModel):
    location: str
    jun_sep_rainfall: float
    oct_dec_rainfall: float
...
def preprocess_input(data: WeatherInput):
    ...
    input_data = np.array([[location_encoded, data.jun_sep_rainfall, data.oct_dec_rainfall]])
...
async def predict_rain(data: WeatherInput):
    ...
    return {"rain_prediction": rain_prediction}
